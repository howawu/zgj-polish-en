...
This guide was distilled from sampled Gongjian Zhou coauthored IEEE/TAES/TSP/TITS papers in the local `zgj` folder, including work on heading constraints, revisit interval uncertainty, range-squared coordinates, spatiotemporal bias compensation, coherent integration, and switch-constrained multiple-model smoothing.
...
4. State the proposed method in a conservative passive construction.
...
- Prefer impersonal subjects over author subjects. Rewrite "we propose", "we can see", and "we assume" as "a ... is proposed", "It can be seen that ...", and "It is assumed that ...".
